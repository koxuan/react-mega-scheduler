...
export default class SchedulerData {
   ...
   //optional
    ...
    _createRenderData() {
        ...
        //end of event rendering
       
//this is the rendering of different people's rows
        if(1 || cellMaxEventsCount <= cellMaxEventsCountValue || this.behaviors.getSummaryFunc !== undefined) {
            initRenderData.forEach((resourceEvents) => {
                let hasSummary = false;
                resourceEvents.headerItems.forEach((headerItem) => {
                    
                    if(1 ||cellMaxEventsCount <= cellMaxEventsCountValue) {
